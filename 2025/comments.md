...
Day 2 is really unefficient, even for part 1 (I had a solution in ~0.7sec but decided to group part 1 and 2 in the same function - don't know why I like it when both parts can work with the same logic).
